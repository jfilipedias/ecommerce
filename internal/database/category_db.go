...
func (cd *CategoryDB) Create(category *entity.Category) (string, error) {
...
func (cd *CategoryDB) GetAll() ([]*entity.Category, error) {
...
func (cd *CategoryDB) GetByID(id string) (*entity.Category, error) {
	var category entity.Category
